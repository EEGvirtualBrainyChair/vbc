...
{	
  ...
  var previewUI : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    previewUI = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (previewUI, new GUIContent("Preview"));
    if (previewUI.boolValue)
